...
# Form implementation generated from reading ui file 'untitled_a.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_INN_QT_INPUT.setGeometry(QtCore.QRect(280, 70, 201, 21))
        self.lineEdit_INN_QT_INPUT.setObjectName("lineEdit_INN_QT_INPUT")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(300, 50, 141, 20))
        self.label.setObjectName("label")
        self.pushButton_Record_to_Excel = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Record_to_Excel.setGeometry(QtCore.QRect(420, 500, 111, 21))
        ...
        self.pushButton_Parse.setGeometry(QtCore.QRect(520, 60, 151, 31))
        ...
        self.label_4.setGeometry(QtCore.QRect(530, 0, 171, 20))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(580, 20, 91, 16))
        self.label_5.setObjectName("label_5")
        self.comboBox_xslm_choice = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_xslm_choice.setGeometry(QtCore.QRect(40, 70, 171, 22))
        self.comboBox_xslm_choice.setObjectName("comboBox_xslm_choice")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(60, 50, 121, 16))
        self.label_6.setObjectName("label_6")
        self.label_14 = QtWidgets.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(500, 410, 141, 20))
        self.label_14.setObjectName("label_14")
        self.comboBox_docfate = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_docfate.setGeometry(QtCore.QRect(460, 440, 211, 21))
        ...
        self.lineEdit_result.setGeometry(QtCore.QRect(450, 530, 231, 20))
        self.lineEdit_result.setStyleSheet("background-color: white")
        self.lineEdit_result.setObjectName("lineEdit_result")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(30, 140, 361, 351))
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(430, 300, 271, 111))
        ...
        self.comboBox_type_doc.setGeometry(QtCore.QRect(430, 200, 261, 21))
        ...
        self.lineEdit_number_docs.setGeometry(QtCore.QRect(520, 150, 191, 20))
        self.lineEdit_number_docs.setObjectName("lineEdit_number_docs")
        self.lineEdit_date = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_date.setGeometry(QtCore.QRect(430, 150, 71, 20))
        self.lineEdit_date.setObjectName("lineEdit_date")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(420, 130, 91, 20))
        self.label_8.setObjectName("label_8")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(580, 130, 101, 20))
        self.label_7.setObjectName("label_7")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(530, 180, 81, 16))
        self.label_13.setObjectName("label_13")
        self.label_22 = QtWidgets.QLabel(self.centralwidget)
        self.label_22.setGeometry(QtCore.QRect(500, 280, 141, 16))
        self.label_22.setObjectName("label_22")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(400, 120, 20, 431))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(40, 30, 671, 20))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_25 = QtWidgets.QLabel(self.centralwidget)
        self.label_25.setGeometry(QtCore.QRect(510, 230, 111, 16))
        self.label_25.setObjectName("label_25")
        self.comboBox_name_doc = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_name_doc.setGeometry(QtCore.QRect(430, 250, 261, 21))
        ...
        self.pushButton_cancel_record.setGeometry(QtCore.QRect(590, 500, 101, 21))
        ...
        self.line_3.setGeometry(QtCore.QRect(40, 110, 671, 20))
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.checkBox_no_parser = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_no_parser.setGeometry(QtCore.QRect(300, 100, 151, 17))
        self.checkBox_no_parser.setObjectName("checkBox_no_parser")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(30, 500, 351, 16))
        self.label_9.setObjectName("label_9")
        self.pushButton_donation = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_donation.setGeometry(QtCore.QRect(160, 530, 211, 21))
        self.pushButton_donation.setStyleSheet("background-color: rgb(187, 255, 176);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><a href=\"https://www.pixelpravo.ru\"><span style=\" text-decoration: underline; color:#0000ff;\">© Nikolai Slesarenko, pixelpravo.ru</span></a></p></body></html>"))
        ...
        self.pushButton_donation.setText(_translate("MainWindow", "Пожертвование на развитие ПО"))
        self.menu.setTitle(_translate("MainWindow", "Настройки"))
        self.menu_excel.setTitle(_translate("MainWindow", "Открыть excel"))
        self.menu_2.setTitle(_translate("MainWindow", "Инструкция / Справка"))
        ...
        self.action_open_excel.setText(_translate("MainWindow", "Открыть текущий excel"))
