...
----------------------------------------------------------------------------------------
Перед запуском:
1) создать папку "Реестры" на рабочем столе, в нее скопировать файл 01_Реестр Тест.xlsm
2) открыть 01_Реестр Тест.xlsm, получить ошибку и разрешить использование макросов
3) в папке 01_SHABLON отркыть шаблоны
4) заменить в шаблонах своими сведениями то, что выделено цветом
...
Дополнительно:
1) Лучше разделить программу отдельно для договоров и отдельно для писем/претензий, поскольку шаблонов может быть много. Это упростит работу.
2) Файл excel можно скопировать, чтобы создать несколько реестров, назвав, 02_Реестр "Название"
----------------------------------------------------------------------------------------
Настройки:
Через основное - настройки можно изменить некоторые значения, например, в разделе [Alphabit Code] item присвавает значение в зависимости от порядкового номера файла excel. 
...
____
Подробнее смотрите в настройках # 
